...
public class ServiceSubCommand {
    ...
    public void infoService(String[] args) {
        ...
        player.sendMessage(messages.get("service.info.online-players").replaceText(text -> text.match("%players%").replacement(String.valueOf(service.getOnlinePlayersCount()))));
